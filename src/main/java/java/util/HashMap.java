/*
 * Copyright (c) 1997, 2017, Oracle and/or its affiliates. All rights reserved. ORACLE PROPRIETARY/CONFIDENTIAL. Use is
 ...
 *
 * If no such object exists, the map should be "wrapped" using the {@link Collections#synchronizedMap
...
public class HashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
     ...
     * element to a bin with at least this many nodes. The value must be greater than 2 and should be at least 8 to mesh
     * with assumptions in tree removal about conversion back to plain bins upon shrinkage.
     */
     ...
     * a bin.) Should be at least 4 * TREEIFY_THRESHOLD to avoid conflicts between resizing and treeification
     * thresholds.
     */
    ...
    /**
     * Basic hash bin node, used for most entries. (See below for TreeNode subclass, and in LinkedHashMap for its Entry
     * subclass.)
     */
