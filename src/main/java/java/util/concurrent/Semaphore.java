...
public class Semaphore implements java.io.Serializable {
     ...
     *
     * @param permits the initial number of permits available. This value may be negative, in which case releases must
     ...
     * @param permits the initial number of permits available. This value may be negative, in which case releases must
     *        occur before any acquires will be granted.
     * @param fair {@code true} if this semaphore will guarantee first-in first-out granting of permits under
     *        contention, else {@code false}
     */
